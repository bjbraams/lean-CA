...
Scalar counterparts appear in Will (Ziang) Li's Mathlib PR #42630 and Stefan Kebekus's Project
VD. See `CREDITS.md`. -/
...
A scalar Cauchy–Pompeiu counterpart is formalized in Will (Ziang) Li's RiemannDynamics. See
`CREDITS.md`. -/
